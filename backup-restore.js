// ============================================================
// 完整備份還原（舊格式：品項主檔/儲位主檔/進出貨紀錄分別分頁）
// 注：現在點「匯出完整交接備份」按鈕跑的是 handover-backup.js 裡新版的 exportFullBackup（JSON 格式，保留所有欄位與文件ID）。
// 這裡只保留 restoreFullBackup，因為 data-import.js 還會用它來輸入舊格式的備份檔（包含「品項主檔」+「儲位主檔」工作表的那種）。
// ============================================================
