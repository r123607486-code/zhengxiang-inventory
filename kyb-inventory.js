...
// ============================================================
// deleteKybItem（改用 runTransaction + change log）
// ============================================================
async function deleteKybItem(itemId, carModel){
...
// ============================================================
// openKybLocationModal（改用 runTransaction + change log）
// ============================================================
function openKybLocationModal(itemId, code){
  ...
  document.getElementById("kybLocSaveBtn").addEventListener("click", ()=>{
    ...
    db.runTransaction(async (firestoreTxn)=>{
      ...
      firestoreTxn.update(db.collection("kybItems").doc(itemId), { locations: newLocs });
...
// ============================================================
// editKybPrice（改用 runTransaction + change log）
// ============================================================
function editKybPrice(itemId, field, label){
  ...
  db.runTransaction(async (firestoreTxn)=>{
    ...
    firestoreTxn.update(db.collection("kybItems").doc(itemId), update);
